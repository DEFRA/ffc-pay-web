...
const schema = Joi.object({
  ...
  pdsConnectionStr: Joi.string().when('useConnectionStr', { is: true, then: Joi.required(), otherwise: Joi.allow('').optional() }),
  ...
  retentionContainer: Joi.string().default('dwh'),
...
const config = {
  ...
  pdsConnectionStr: process.env.PDS_AZURE_STORAGE_CONNECTION_STRING,
  ...
  retentionContainer: process.env.AZURE_STORAGE_RETENTION_CONTAINER,
