...
const { holdAdmin, schemeAdmin, dataView, manualPaymentsAdmin } = require('../auth/permissions')

const HTTP_STATUS = require('../constants/http-status-codes')
const AUTH_SCOPE = { scope: [holdAdmin, schemeAdmin, dataView, manualPaymentsAdmin] }
